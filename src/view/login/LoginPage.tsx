...
//import Logo from "/src/icons/logo-sociologia.svg?react";
            ...
            <div className="md:col-span-3 flex justify-center items-start border-[var(--color-info-content)]">
              <div className="p-4 w-full max-w-lg">
                ...
                <form onSubmit={onSubmit} noValidate className="space-y-2">
                  ...
                  {/* Submit */}
                  <button
                    className="w-full py-3 px-4 bg-gradient-to-r bg-[var(--color-blue)] hover:from-blue-800 hover:to-indigo-800 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                    type="submit"
